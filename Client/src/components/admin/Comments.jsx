...
import ComentTableItem from './ComentTableItem'
...
const Comments = () => {
  ...
  return (
    <div className='flex-1 pt-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      ...
      <div className='relative h-5/5 max-w-3xl overflow-x-auto mt-4 bg-white shadow rounded-lg scrollbar-hide'>
          ...
          <tbody>
            {
              comments.filter((comment) => {
                ...
                <ComentTableItem key={comment._id || index} comment={comment} index={index + 1} fetchComments={fetchComments} />
              ))
            }
          </tbody>
        </table>
